...
<div class="container">
    <div class="row justify-content-center">
        <div class="col">
            <edit-transfer :sheetid="{{ $account->latestSheet->id }}" :transferid="{{ $transfer->id }}" inline-template>
                <div class="card">
                    <div class="card-header">
                        <div class="pull-left d-inline-block">Edit {{ $transfer->name }} for {{ $account->name }}</div>
